...
export interface User extends BaseDocument {
  ...
  assignedZips?: string[];
  // Mobile number is now required for all roles for SMS notifications
  mobile?: string;
}
...
// Retailer - Simplified for new system
export interface Retailer extends BaseDocument {
  name: string; // Store name
  phone: string; // Primary identifier for SMS
  email?: string;
  address?: string;
  area: string; // Area name for search and filtering
  status: 'ACTIVE' | 'INACTIVE';
  // Mobile number for SMS notifications (can be same as phone)
  mobile?: string;
}
...
// Payment - Simplified for new system
export interface Payment extends BaseDocument {
  retailerId: string;
  retailerName: string; // Historical retailer name
  lineWorkerId: string;
  lineWorkerName: string; // Historical line worker name
  totalPaid: number;
