...
import { NewSuperAdminDashboard } from '@/components/NewSuperAdminDashboard';
...
export default function Home() {
  ...
  if (showRoleSelection) {
    return (
      <RoleSelection 
        onRoleSelect={(role) => {
          // Retailer login removed - only show role selection for non-retailer roles
  ...
  // Route based on user role - Use new simplified dashboards
